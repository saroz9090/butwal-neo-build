    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center max-w-5xl">
          {/* Trust/Location line */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/20 backdrop-blur-md border border-primary/40 text-primary-foreground text-xs sm:text-sm font-semibold mb-6 animate-fade-in">
            <MapPin className="w-4 h-4 text-primary" />
            <span>Head Office: Butwal • Regional Branch: Dang (Ghorahi | Tulsipur | Lamahi)</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-foreground tracking-tight font-heading leading-tight mb-6">
            Professional Construction Services in <br className="hidden sm:inline" />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-400 via-primary to-pink-400 font-black drop-shadow-sm">Butwal & Dang</span>
          </h1>

          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto font-normal leading-relaxed">
            From house construction and planning to complete project execution, <strong>Butwal Construction & Builders</strong> provides reliable, earthquake-resistant construction solutions with our established headquarters in Butwal and regional branch in Dang.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-base px-6 shadow-xl glow">
              <Link to="/estimate">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="bg-[#25D366]/20 border-[#25D366]/60 text-white hover:bg-[#25D366] hover:text-white font-bold text-base px-6"
            ...
            <Button asChild size="lg" variant="outline" className="border-primary/40 hover:bg-primary/10 font-semibold text-base px-6">
              <Link to="/blog">
                <BookOpen className="mr-2 h-5 w-5 text-primary" />
                Read Construction Blog
              </Link>
            </Button>
            <Button asChild size="lg" variant="ghost" className="text-foreground hover:bg-accent font-semibold">
              <Link to="/dang">
                Explore Dang Branch →
              </Link>
            </Button>
      ...
      {/* 2. Trust & Credibility / Why Choose Us */}
      <section className="py-12 bg-card/60 border-y border-border/50">
      ...
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {coreServices.map((srv, idx) => (
            <Card key={idx} className="glass p-6 hover-lift border-border/60 flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-4">
                  <srv.icon size={24} />
                </div>
                <h3 className="text-xl font-bold text-foreground mb-2">{srv.title}</h3>
      ...
      {/* Interactive Apps & Planning Tools Hub Showcase */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card key={idx} className="glass p-6 hover-lift border-border/60 flex flex-col justify-between group">
                <div>
                ...
                <div className="pt-6 border-t border-border/40 mt-6">
                  <Button asChild size="sm" variant="outline" className="w-full border-primary/40 hover:bg-primary hover:text-white font-semibold">
                    <Link to={tool.link}>
                      {tool.cta} →
                    </Link>
                  </Button>
      ...
      {/* 4. Dedicated Dang Branch Highlight Banner */}
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                <Button 
                  ...
                  className="text-green-500 border-green-500/40 hover:bg-green-500 hover:text-white font-semibold"
                >
      ...
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {processSteps.map((phase, idx) => (
            <Card key={idx} className="glass p-6 text-center hover-lift relative overflow-hidden flex flex-col justify-between">
              <div>
                <div className="text-4xl font-black text-primary/20 mb-2 font-mono">{phase.step}</div>
              ...
              <div className="w-8 h-1 bg-primary/40 mx-auto mt-4 rounded-full" />
            </Card>
          ))}
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, idx) => (
              <Card key={idx} className="glass p-6 flex flex-col justify-between">
                <div>
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="p-8 sm:p-12 rounded-3xl glass border border-primary/40 text-center relative overflow-hidden bg-gradient-to-br from-card via-primary/10 to-blue-500/10 shadow-2xl max-w-4xl mx-auto">
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-xl glow">
                <Link to="/estimate">
                  <Calculator className="mr-2 h-5 w-5" />
      ...
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {blogPosts.slice(0, 3).map((post) => (
            <Card key={post.id} className="glass overflow-hidden hover-lift flex flex-col justify-between">
              <div>
                <div className="relative aspect-video overflow-hidden">
                  <LazyImage
                ...
                <div className="p-5">
                  ...
                  <h4 className="font-bold text-foreground text-base line-clamp-2">{post.title}</h4>
      ...
      {/* 11. Explore All Specialty Portals & Sub-Pages */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {[
              ...
              <Card key={idx} className="glass p-5 rounded-2xl border-border/70 hover-lift flex flex-col justify-between group">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 rounded-xl bg-primary/15 text-primary border border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <portal.icon size={20} />
                    </div>
      ...
      {/* 12. Dual Presence Contact & Regional Locations */}
      <section className="py-20 bg-card/40 border-t border-border/40">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="glass p-8 border-border/60 hover-lift">
            ...
            {/* Dang Branch Office */}
            <Card className="glass p-8 border-primary/30 hover-lift">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary font-bold">
                  <Building2 className="w-6 h-6" />
                </div>
              ...
              <div className="pt-6 border-t border-border/40 mt-6 flex gap-3">
                <Button asChild size="sm" variant="outline" className="border-primary/40 font-bold">
